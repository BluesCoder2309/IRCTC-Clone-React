            ...
            <form>
               ...
               <div className={styles.inputGroup}>
                  ...
                  <div className={styles.inputWrapper}>
                     ...
                     <select className={styles.select} name="class" id="class">
               ...
               <div className={styles.buttonGroup}>
                  <button className={styles.searchButton} type="submit">Search Train</button>
                  <button className={styles.showTrain} type="submit">Show All Train</button>
               </div>
            </form>
         </div>
      </>
